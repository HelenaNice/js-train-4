...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  var codePointAtResult = string.codePointAt(index);
   ...
   return `charCodeAt:${charCodeAtResult},
...
// Завдання 16: Напишіть функцію, яка видаляє* вибирає частину рядка між двома індексами

function sliceString(string, startIndex, endIndex) {
  return string.slice(startIndex, endIndex);
    // Використовуємо метод slice(), щоб ВИБРАТИ-ЕКСТАГУВАТИ САМЕ ЦЮ ЧАСТИНУ рядка string між двома індексами startIndex та endIndex
}

console.log("Завдання 16 ====================================");
console.log(
  'sliceString("Hello, world!", 0, 5)', sliceString("Hello, world!", 0, 5)
); // Виведе 'Hello'
...
function substringString(string, startIndex, endIndex) {
  ...
  // Використовуємо метод substring(), щоб відокремити частину рядка string між двома індексами startIndex та endIndex
}

console.log("Завдання 17 ====================================");
console.log(
  'substringString("Hello, world!", 0, 5)',  substringString("Hello, world!", 0, 5)
); // Виведе 'Hello'
